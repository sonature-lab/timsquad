...
name: tsq-hono
description: |
  Hono Framework 백엔드 개발 가이드라인. 비동기 우선, Zod 타입 안전, Clean Architecture 레이어 분리.
  Use when: Hono 라우트 작성, Node.js 백엔드 구현, 미들웨어 설계, API 엔드포인트 개발, zValidator 사용 시.
version: "1.1.0"
tags: [tsq, hono, nodejs, backend]

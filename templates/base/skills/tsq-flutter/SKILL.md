...
name: tsq-flutter
description: |
  Flutter 개발 가이드라인. Feature-first 아키텍처, Riverpod 상태관리, 위젯 합성, 성능 최적화, 크로스플랫폼 적응형 UI.
  Use when: Flutter 위젯 작성·수정, 상태관리 설계, 크로스플랫폼 UI 구현, pubspec.yaml 설정 시.
version: "1.0.0"
tags: [tsq, flutter, mobile, cross-platform, riverpod]

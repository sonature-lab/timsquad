...
name: tsq-ddd
description: |
  Domain-Driven Design 전략적 설계 가이드라인. Bounded Context, Ubiquitous Language, Context Map.
  Use when: 도메인 모델링, Bounded Context 설계, 유비쿼터스 언어 정의, 컨텍스트 맵 작성 시.
version: "1.0.0"
tags: [tsq, ddd, methodology, architecture]
user-invocable: false
compatible-with: [tsq-tdd, tsq-bdd]
---
